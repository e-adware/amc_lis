...
<div class="container-fluid">
	<table class="table table-bordered text-center">
		<tr>
			<td colspan="2">
				<span class="side_name" style="display:none;">Registration Type</span>
				<select class="span2" id="pat_type" onChange="view_all()" style="margin-left: 138px;display:none;">
		...
		<tr>
			<td>
				...
				<input class="form-control datepicker span2" type="text" name="from" id="from" value="<?php echo $fdate_str; ?>" style="margin-left: 47px;">
				<span class="side_name">To</span>
				<input class="form-control datepicker span2" type="text" name="to" id="to" value="<?php echo $tdate_str; ?>" style="margin-left: 26px;">
				<button class="btn btn-search" onClick="view_all()" style="margin-top: 0%;" ><i class="icon-search"></i> Search</button>
			</td>
			<td>
				<span class="side_name">Name</span>
				<input type="text" class="span2" id="pat_name" onKeyup="view_all()" value="<?php echo $name_str; ?>" style="margin-left: 52px;">
			</td>
		</tr>
		<tr>
			<td>
				<span class="side_name">UHID</span>
				<input list="browsrs" type="text" class="span2" id="uhid" onKeyup="view_all()" value="<?php echo $uhid_str; ?>" style="margin-left: 47px;">
				<datalist id="browsrs">
				<?php
				...
				<input list="browsr" type="text" class="span2" id="pin" onKeyup="view_all()" value="<?php echo $pin_str; ?>" style="margin-left: 58px;">
				<datalist id="browsr">
				<?php
			...
			<td>
				<span class="side_name">Phone</span>
				<input type="text" class="span2" id="phone" onKeyup="view_all()" value="<?php echo $phone_str; ?>" style="margin-left: 55px;">
			</td>
		</tr>
	</table>
...
<script>
	...
	{
		if(e.ctrlKey && e.keyCode==53) // 5
		{
			department_status(1);
		}
		if(e.ctrlKey && e.keyCode==54) // 6
		{
			department_status(2);
		}
	});
	...
	{
		var url="pages/department_status.php?dt1="+btoa($('#from').val())+"&dt2="+btoa($('#to').val())+"&tYp="+btoa(n);
