		...
		?>
			...
			<td>
				...
				<?php
					...
					?>
							<button id="btn_<?php echo $btn_id;?>" class="<?php echo $cls;?>" onclick="load_pat_dept_tests('<?php echo $i;?>','<?php echo $type_id;?>')" <?php echo $btnDisabled;?>><?php echo $dept_info["name"];?></button>
					<?php
						}
					}
				?>
...
?>
		...
		?>
			...
			<td>
				<label><input type="checkbox" class="checks" onchange="check_all_chks()" value="<?php echo $patient_id."@".$test_det['opd_id'];?>" /> Select</label>
			</td>
		</tr>
<?php
		$i++;
