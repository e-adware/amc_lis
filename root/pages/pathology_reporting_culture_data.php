...
if($_POST["type"]=="load_culture_data")
{
	...
	$cult_test=$culture_setup_testid; // From connection file
...
?>
		...
		<tr>
			<td colspan="4" style="text-align:center;">
				<button class="btn btn-save" id="save" name="t_par<?php echo $i;?>" onclick="save_culture('<?php echo $testid;?>','<?php echo $iso_no;?>','1')" <?php echo $disabled_doc_approved;?>><i class="icon-save"></i> Save &amp; Validate</button>
				
				<button class="btn btn-new" id="summary" name="summary" onclick="add_summary('<?php echo $testid;?>','<?php echo $iso_no;?>')"><i class="icon-edit"></i> <?php echo $summary_btn_name;?> Summary</button>
...
if($_POST["type"]=="load_culture_iso_data")
{
	...
	$i=1;
	$cult_test=3374; //------------Loading parameter of Urine culture & Sensitivity ----------//
?>
	<div>
