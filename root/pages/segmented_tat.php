        ...
        <tr>
            <th class="head">
                <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
                    ...
                    <select class="span2" id="sel_priority">
...
<script>
    ...
    function print_table(f_date, t_date, sel_test, priority) {
        $.post("pages/segmented_tat_data.php",
            {
                type: "load_data",
                mode: "print",
            ...
            function (data, status) {
                ...
                printWindow.document.write('<html><head><title>Segmentd TAT Data</title>');
    ...
    function exportTableToExcel(f_date, t_date, sel_test, priority) {
        var url = "pages/segmented_tat_excel.php?f_date=" + btoa(f_date) + "&t_date=" + btoa(t_date) + "&sel_test=" + btoa(sel_test) + "&priority=" + btoa(priority);
