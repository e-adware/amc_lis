		...
		<table class="table table-bordered table-condensed text-center">
			...
			<tr>
				<td style="text-align:center;font-weight:bold">
					<!--Cash Memo No.--> <br /> <input type="text" id="bill_no" style="<?php echo $pat_typ; ?>"
				...
				<td style="text-align:center;font-weight:bold; display: none;<?php echo $bar_sty; ?>">
					Cashmemo No <br /> <input type="text" id="barcode_id" list="bar_list"
						onkeyup="load_pat_event(event)" />
				...
				<td style="text-align:center;font-weight:bold; display: none;">
					<br>
					...
					<input type="text" id="dept_serial_no" class="span1" style="<?php echo $pat_typ; ?>"
...
<script>
	...
	function openWithPost(url, params, windowName, windowFeatures) {
		// Open the target window first with custom features
	...
	function print_selected() {
		...
		if (chk.length == 0) {
			...
			//const url = 'pages/report_batch_print_report.php'; // Test endpoint to verify POST data
			//const features = 'fullscreen=yes,scrollbars=yes,menubar=yes';
			//openWithPost(url, { opds: opds }, 'popupWindow', features);
		}
	}
	...
	function load_pat_ser(val) {
		...
		$.post("pages/pathology_result_approve_tech_data.php",
			{
				type: "load_pat_list_multi_print",
