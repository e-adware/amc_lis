...
if($type==1)
{
	...
	<button type="button" class="btn btn-primary btn-mini btn_act" onclick="report_print('<?php echo base64_encode($fdate);?>','<?php echo base64_encode($tdate);?>','<?php echo base64_encode($dep);?>','<?php echo base64_encode($type);?>')">Print</button>
	<button type="button" class="btn btn-success btn-mini btn_act" onclick="report_export('<?php echo base64_encode($fdate);?>','<?php echo base64_encode($tdate);?>','<?php echo base64_encode($dep);?>','<?php echo base64_encode($type);?>')">Export</button>
	</span>
