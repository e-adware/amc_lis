		...
		<table class="table table-condensed">
			<tr>
				<td colspan="5">
					<center>
						...
						<select id="search_dept_id" name="search_dept_id" onchange="load_dep_test()" class="span2" style="display:none;">
			...
			<tr>
				<td  style="text-align:center;font-weight:bold">
					<!--Cash Memo No.--> <br/> <input type="text" id="bill_no" style="display:none;" onkeyup="load_pat_event(event)"/>
				...
				<td  style="text-align:center;font-weight:bold">
					...
					<input type="text" id="dept_serial_no" class="span1" style="display:none;" onkeyup="dept_serial_no_up(event)">
				</td>
				<td  style="text-align:center;font-weight:bold">
					Name <br/> 
