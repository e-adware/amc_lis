<?php
$test_str="SELECT DISTINCT b.`testid`,b.`testname` FROM `patient_test_details` a, `testmaster` b WHERE a.`testid`=b.`testid` AND a.`patient_id`='$patient_id' AND a.`opd_id`='$opd_id' AND a.`ipd_id`='$ipd_id' AND a.`batch_no`='$batch_no' AND b.`type_id`='$dept_id'"; // AND a.`main_tech`>0

if($barcode_id!="")
{
	$test_str="SELECT DISTINCT b.`testid`,b.`testname` FROM `patient_test_details` a, `testmaster` b, `test_sample_result` c WHERE a.`testid`=b.`testid` AND a.`patient_id`=c.`patient_id` AND a.`opd_id`=c.`opd_id` AND a.`ipd_id`=c.`ipd_id` AND a.`batch_no`=c.`batch_no` AND a.`patient_id`='$patient_id' AND a.`opd_id`='$opd_id' AND a.`ipd_id`='$ipd_id' AND a.`batch_no`='$batch_no' AND b.`type_id`='$dept_id'";  // AND a.`main_tech`>0
...
<div id="pat_dept_test_params">
	<button class="btn btn-print btn-mini" style="float:right;" onclick="print_preview('1','<?php echo $dept_id; ?>','<?php echo $barcode_id; ?>')"><i class="icon-print"></i> Print Preview</button>
...
?>
		<tr>
			...
			<td style="text-align:center;">
				<button class="btn btn-edit btn-mini test_note_btn" onclick="test_note('<?php echo $testid; ?>')" <?php echo $test_note_disable; ?> <?php echo $disabled_doc_approved; ?>><i class="icon-comment-alt"></i> <?php echo $test_note_btn; ?></button>
			</td>
		</tr>
		<tr>
			<td colspan="7" class="culture_td">
				<div>
					...
					<select id="growth_val<?php echo $testid; ?>" onchange="load_culture_data('<?php echo $testid; ?>')" style="margin-left: 112px;" <?php echo $disabled_doc_approved; ?>>
					...
					<span id="iso_field<?php echo $testid; ?>" style="<?php echo $iso_no_display; ?>">
						...
						<select class="span2" id="iso_no_total<?php echo $testid; ?>" onchange="load_culture_data('<?php echo $testid; ?>')" style="margin-left: 84px;" <?php echo $disabled_doc_approved; ?>>
						<?php
							for($z=0;$z<=10;$z++)
							{
...
<?php
	...
	else
	{
		...
		if($testid==1227) // Widal
		{
			...
			if($w1["doc"]>0)
			{
				$test_result["doc"]=$w1["doc"];
			}
			if($w2["doc"]>0 && $test_result["doc"]==0)
			{
				$test_result["doc"]=$w2["doc"];
			}
			if($w3["doc"]>0 && $test_result["doc"]==0)
			{
				$test_result["doc"]=$w3["doc"];
			}
			if($w4["doc"]>0 && $test_result["doc"]==0)
			{
				$test_result["doc"]=$w4["doc"];
			}
			...
			<tr>
				...
				<td>
					<label name="approve_test<?php echo $testid; ?>">
						<input type="checkbox" class="<?php echo $approve_cls; ?>" id="<?php echo $approve_id; ?>" value="<?php echo $testid; ?>" <?php echo $approve_function; ?> <?php echo $doc_approve_disabled; ?> <?php echo $chk_box; ?> >
					<?php
						if($w1["doc"]>0)
						{
							$tech_name=mysqli_fetch_array(mysqli_query($link, "SELECT `name` FROM `employee` WHERE `emp_id`='$w1[doc]'"));
					...
					<div class="widal_result">
						<table class="table table-condensed table-bordered" style="width: 100% !important;">
							<tr>
								...
								<td>
									<input type="text" id="incubation_temp" value="<?php echo $w1["incubation_temp"]?>" <?php echo $doc_approve_disabled; ?>>
								</td>
								<th>Method</th>
								<td>
									<input type="text" id="method" value="<?php echo $w1["method"]?>" list="method_list" <?php echo $doc_approve_disabled; ?>>
						...
						<table class="table table-condensed table-bordered" style="width: 100% !important;">
							...
							<tr>
								...
								<th>"O"</th>
								<td><input type="text" name="t_par1" id="o0" style="width: 80px !important;" class="td_widal" value="<?php echo $w1['F1']?>" maxlength='3' onkeyup="chk_widal1(1,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
								<td><input type="text" name="t_par2" id="o1" style="width: 80px !important;" class="td_widal" value="<?php echo $w1['F2']?>" maxlength='3' onkeyup="chk_widal1(2,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
								<td><input type="text" name="t_par3" id="o2" style="width: 80px !important;" class="td_widal" value="<?php echo $w1['F3']?>" maxlength='3' onkeyup="chk_widal1(3,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
								<td><input type="text" name="t_par4" id="o3" style="width: 80px !important;" class="td_widal" value="<?php echo $w1['F4']?>" maxlength='3' onkeyup="chk_widal1(4,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
								<td><input type="text" name="t_par5" id="o4" style="width: 80px !important;" class="td_widal" value="<?php echo $w1['F5']?>" maxlength='3' onkeyup="chk_widal1(5,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
								<td><input type="text" name="t_par6" id="o5" style="width: 80px !important;" class="td_widal" value="<?php echo $w1['F6']?>" maxlength='3' onkeyup="chk_widal1(6,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
							</tr>
							<tr>
								<th style="text-align:left">"H"</th>
								<td><input type="text" name="t_par7" id="h0" style="width: 80px !important;" class="td_widal" value="<?php echo $w2['F1']?>" maxlength='3' onkeyup="chk_widal1(7,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
								<td><input type="text" name="t_par8" id="h1" style="width: 80px !important;" class="td_widal" value="<?php echo $w2['F2']?>" maxlength='3' onkeyup="chk_widal1(8,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
								<td><input type="text" name="t_par9" id="h2" style="width: 80px !important;" class="td_widal" value="<?php echo $w2['F3']?>" maxlength='3' onkeyup="chk_widal1(9,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
								<td><input type="text" name="t_par10" id="h3" style="width: 80px !important;" class="td_widal" value="<?php echo $w2['F4']?>" maxlength='3' onkeyup="chk_widal1(10,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
								<td><input type="text" name="t_par11" id="h4" style="width: 80px !important;" class="td_widal" value="<?php echo $w2['F5']?>" maxlength='3' onkeyup="chk_widal1(11,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
								<td><input type="text" name="t_par12" id="h5" style="width: 80px !important;" class="td_widal" value="<?php echo $w2['F6']?>" maxlength='3' onkeyup="chk_widal1(12,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
							</tr>
							<tr>
								<th style="text-align:left">"A(H)"</th>
								<td><input type="text" name="t_par13" id="ah0" style="width: 80px !important;" class="td_widal" value="<?php echo $w3['F1']?>" maxlength='3' onkeyup="chk_widal1(13,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
								<td><input type="text" name="t_par14" id="ah1" style="width: 80px !important;" class="td_widal" value="<?php echo $w3['F2']?>" maxlength='3' onkeyup="chk_widal1(14,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
								<td><input type="text" name="t_par15" id="ah2" style="width: 80px !important;" class="td_widal" value="<?php echo $w3['F3']?>" maxlength='3' onkeyup="chk_widal1(15,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
								<td><input type="text" name="t_par16" id="ah3" style="width: 80px !important;" class="td_widal" value="<?php echo $w3['F4']?>" maxlength='3' onkeyup="chk_widal1(16,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
								<td><input type="text" name="t_par17" id="ah4" style="width: 80px !important;" class="td_widal" value="<?php echo $w3['F5']?>" maxlength='3' onkeyup="chk_widal1(17,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
								<td><input type="text" name="t_par18" id="ah5" style="width: 80px !important;" class="td_widal" value="<?php echo $w3['F6']?>" maxlength='3' onkeyup="chk_widal1(18,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
							</tr>
							<tr>
								<th style="text-align:left">"B(H)"</th>
								<td><input type="text" name="t_par19" id="bh0" style="width: 80px !important;" class="td_widal" value="<?php echo $w4['F1']?>" maxlength='3' onkeyup="chk_widal1(19,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
								<td><input type="text" name="t_par20" id="bh1" style="width: 80px !important;" class="td_widal" value="<?php echo $w4['F2']?>" maxlength='3' onkeyup="chk_widal1(20,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
								<td><input type="text" name="t_par21" id="bh2" style="width: 80px !important;" class="td_widal" value="<?php echo $w4['F3']?>" maxlength='3' onkeyup="chk_widal1(21,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
								<td><input type="text" name="t_par22" id="bh3" style="width: 80px !important;" class="td_widal" value="<?php echo $w4['F4']?>" maxlength='3' onkeyup="chk_widal1(22,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
								<td><input type="text" name="t_par23" id="bh4" style="width: 80px !important;" class="td_widal" value="<?php echo $w4['F5']?>" maxlength='3' onkeyup="chk_widal1(23,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
								<td><input type="text" name="t_par24" id="bh5" style="width: 80px !important;" class="td_widal" value="<?php echo $w4['F6']?>" maxlength='3' onkeyup="chk_widal1(24,this.id,event)" <?php echo $doc_approve_disabled; ?> /></td>
							</tr>
							<tr>
								<th colspan="2">IMPRESSION</th>
								<td colspan="7">
									<textarea id="impression" name="t_par25" style="width: 98%;resize: none;" <?php echo $doc_approve_disabled; ?>><?php if($w4['DETAILS']){ echo $w4['DETAILS'];}else{ echo "Titre Insignificant";}?></textarea>
								</td>
							</tr>
						</table>
					</div>
...
<?php
			...
			if($param_info["ResultType"]!=5) // Sub-Heading End
			{
				...
				$instrument_id=0;
				$result_hide=0;
				$test_result=mysqli_fetch_array(mysqli_query($link, "SELECT `slno`,`result`,`range_status`,`range_id`,`status`,`tech_note`,`doc_note`,`instrument_id`,`result_hide`,`doc`,`tech`,`main_tech`,`for_doc` FROM `testresults` WHERE `patient_id`='$patient_id' AND `opd_id`='$opd_id' AND `ipd_id`='$ipd_id' AND `batch_no`='$batch_no' AND `testid`='$testid' AND `paramid`='$paramid' AND `iso_no`='$iso_no'"));
				if($test_result)
				{
					...
					if($instrument_id>0 && $test_result["status"]>1)
					{
...
?>
			...
			?>
					<td>
						<input type="text" class="t_par" name="t_par<?php echo $i; ?>" id="<?php echo $testid; ?>PRM<?php echo $paramid; ?>" param_testid="<?php echo $testid; ?>" iso_no="<?php echo $iso_no; ?>" instrument_id="<?php echo $instrument_id; ?>" slno="<?php echo $i; ?>" value="<?php echo $result; ?>" <?php echo $form_onkeyup; ?> style="<?php echo $result_text_style; ?>" <?php echo $doc_approve_disabled; ?>>
					
					<?php
						
						if($dontPrint_param_btn_data)
						{
			...
			?>
					<td>
						<input type="text" class="t_par" name="t_par<?php echo $i; ?>" id="<?php echo $testid; ?>PRM<?php echo $paramid; ?>" param_testid="<?php echo $testid; ?>" iso_no="<?php echo $iso_no; ?>" instrument_id="<?php echo $instrument_id; ?>" slno="<?php echo $i; ?>" value="<?php echo $result; ?>" <?php echo $form_onfocus; ?> style="<?php echo $result_text_style; ?>" <?php echo $doc_approve_disabled; ?>>
			...
			?>
					<td>
						<input type="text" class="t_par" name="t_par<?php echo $i; ?>" id="<?php echo $testid; ?>PRM<?php echo $paramid; ?>" param_testid="<?php echo $testid; ?>" iso_no="<?php echo $iso_no; ?>" instrument_id="<?php echo $instrument_id; ?>" slno="<?php echo $i; ?>" value="<?php echo $result; ?>" <?php echo $form_onkeyup; ?> <?php echo $doc_approve_disabled; ?>>
			...
			?>
					<td colspan="3">
						<input type="text" class="t_par" name="t_par<?php echo $i; ?>" id="<?php echo $testid; ?>PRM<?php echo $paramid; ?>" param_testid="<?php echo $testid; ?>" iso_no="<?php echo $iso_no; ?>" instrument_id="<?php echo $instrument_id; ?>" slno="<?php echo $i; ?>" value="<?php echo $result; ?>" style="" <?php echo $doc_approve_disabled; ?>>
			...
			?>
					<td colspan="3">
						<textarea rows="6" class="t_par" name="t_par<?php echo $i; ?>" id="<?php echo $testid; ?>PRM<?php echo $paramid; ?>" param_testid="<?php echo $testid; ?>" iso_no="<?php echo $iso_no; ?>" instrument_id="<?php echo $instrument_id; ?>" slno="<?php echo $i; ?>" style="resize:none;width:98%;" <?php echo $doc_approve_disabled; ?>><?php echo $result; ?></textarea>
					</td>
			<?php
				}
					...
					<td colspan="4">
						<div id="padd_display_div<?php echo $i; ?>">
							<div style="text-align:right;">
								<button class="btn btn-new btn-mini" onclick="load_editor('<?php echo $i; ?>')"><i class="icon-edit"></i> <?php echo $pad_summary_btn; ?></button>
							</div>
					...
					?>
						<div id="padd_edit_div<?php echo $i; ?>" style="display:none;">
							<div id="padd<?php echo $testid; ?>PRM<?php echo $paramid; ?>">
								<textarea rows="6" class="t_par" name="t_par<?php echo $i; ?>" id="<?php echo $testid; ?>PRM<?php echo $paramid; ?>" param_testid="<?php echo $testid; ?>" iso_no="<?php echo $iso_no; ?>" instrument_id="<?php echo $instrument_id; ?>" slno="<?php echo $i; ?>" padd="1" style="resize:none;width:98%;" <?php echo $doc_approve_disabled; ?>><?php echo $result; ?></textarea>
							</div>
							<center>
								<button class="btn btn-save" onclick="save_param_summary('<?php echo $testid; ?>','<?php echo $paramid; ?>','<?php echo $iso_no; ?>','<?php echo $instrument_id; ?>')" <?php echo $doc_approve_disabled; ?>><i class="icon-save"></i> Save &amp; Validate</button>
			...
			?>
					...
					<td>
					<?php
						if(($test_result["result"] || $test_sample_result["result"]) && $repeat_parameter==1)
						{
					?>
						<label id="repeat_param_label<?php echo $testid; ?>tst<?php echo $paramid; ?>">
							<input type="checkbox" id="repeat_param<?php echo $testid; ?>tst<?php echo $paramid; ?>" onclick="repeat_param_save('<?php echo $patient_id; ?>','<?php echo $opd_id; ?>','<?php echo $ipd_id; ?>','<?php echo $batch_no; ?>','<?php echo $testid; ?>','<?php echo $paramid; ?>','0','<?php echo $param_info["Name"]; ?>','<?php echo $dept_id; ?>')" <?php echo $doc_approve_disabled; ?>>
							Repeat
						</label>
					<?php
						}
					?>
						<button class="btn btn-excel btn-mini" id="repeat_param_view_btn<?php echo $testid; ?>tst<?php echo $paramid; ?>" onclick="repeat_param_view('<?php echo $patient_id; ?>','<?php echo $opd_id; ?>','<?php echo $ipd_id; ?>','<?php echo $batch_no; ?>','<?php echo $testid; ?>','<?php echo $paramid; ?>','0')" style="<?php echo $repeat_btn_show; ?>"><i class="icon-eye-open"></i> View Repeat(s)</button>
					</td>
...
<?php
	...
	$chk_box="";
	$approve_cls="";
	$pat_test_summary=mysqli_fetch_array(mysqli_query($link, "SELECT `summary`,`doc`,`main_tech` FROM `patient_test_summary` WHERE `patient_id`='$patient_id' AND `opd_id`='$opd_id' AND `ipd_id`='$ipd_id' AND `batch_no`='$batch_no' AND `testid`='$testid'")); //  AND `main_tech`>0"
	if($pat_test_summary)
	{
		...
		$doc_approve_disabled="";
		if($pat_test_summary["doc"]>0 && $pat_test_summary["doc"]!=$c_user)
		{
			$doc_approve_disabled="disabled='disabled'";
		...
		<tr>
			<td colspan="4" style="width: 550px;">
				<div id="summary_display_div<?php echo $testid; ?>">
					<div style="text-align:right;">
						<button class="btn btn-excel btn-mini" onclick="load_summary_editor('<?php echo $testid; ?>')" <?php echo $doc_approve_disabled; ?>><i class="icon-edit"></i> Edit Summary</button>
					</div>
				...
				<div id="summary_edit_div<?php echo $testid; ?>" style="display:none;">
					<div id="tpadd<?php echo $testid; ?>">
						<textarea rows="6" class="test_summ" name="test_summ<?php echo $testid; ?>" id="test_summ_id<?php echo $testid; ?>" padd="1" style="resize:none;width:98%;"><?php echo $result; ?></textarea>
					</div>
					<center>
						...
						<button class="btn btn-back" onclick="back_summary_editor('<?php echo $testid; ?>')"><i class="icon-backward"></i> Back</button>
					</center>
				</div>
			</td>
			<td>
				<label name="test_summary<?php echo $testid; ?>">
					<input type="checkbox" class="<?php echo $approve_cls; ?>" id="approve_test_summary<?php echo $testid; ?>" value="<?php echo $testid; ?>" <?php echo $approve_function; ?> <?php echo $doc_approve_disabled; ?> <?php echo $chk_box; ?> >
				<?php
					if($pat_test_summary["doc"]>0)
					{
						$tech_name=mysqli_fetch_array(mysqli_query($link, "SELECT `name` FROM `employee` WHERE `emp_id`='$pat_test_summary[doc]'"));
						echo "Validated<br><small>(".$tech_name["name"].")</small>";
					}else
					{
						echo "Validate";
...
?>
		<tr>
			<td colspan="4" style="width: 550px;">
				<div id="summary_display_div<?php echo $testid; ?>">
					<div style="text-align:right;">
						<button class="btn btn-excel btn-mini" onclick="load_summary_editor('<?php echo $testid; ?>')" <?php echo $doc_approve_disabled; ?>><i class="icon-edit"></i> <?php echo $btn_name; ?></button>
					</div>
					<div ondblclick="load_summary_editor('<?php echo $testid; ?>')" title="Double Click to edit">
					<?php
						if($result_display)
		...
		?>
				<label name="test_summary<?php echo $testid; ?>">
					<input type="checkbox" class="<?php echo $approve_cls; ?>" id="approve_test_summary<?php echo $testid; ?>" value="<?php echo $testid; ?>" <?php echo $approve_function; ?> <?php echo $doc_approve_disabled; ?> <?php echo $chk_box; ?> > Validate
				</label>
		<?php
			}
		?>
...
?>
		<button class="btn btn-back btn-mini" onclick="back_to_list()"><i class="icon-backward"></i> Back To List (ESC)</button>
	</center>
</div>
