...
<div id="content-header">
    <div class="header_div">
		<span class="header"> Phlebotomy Sample</span>
		<!--<span style="float:right;">
			<input type="text" id="manaul_barcode" onkeyup="manaul_barcode_up(this,event)" placeholder="Enter to print barcode">
		</span>-->
	</div>
</div>
<!--End-header-->
	...
	<table class="table table-bordered text-center">
		...
		<tr>
			...
			<td style="text-align:left">
				<input type="text" class="span2" id="patientNo" class="src" placeholder="Search Hospital No" onKeyup="view_pat_event(this,event)" autofocus>
				<input type="text" class="span2" id="barcode" class="src" placeholder="Search Cashmemono" onKeyup="view_pat_event(this,event)" autofocus>
			</td>
		</tr>
	</table>
...
<script>
	...
	*/
	...
	//Manaul Barcode
	function manaul_barcode_up(dis,e)
	{
		if(e.which==13)
		{
			if($(dis).val().trim()!="")
			{
				var url="../js_print/manaul_barcode.php?data="+$(dis).val().trim();
				window.open(url,'Window','scrollbars=1,menubar=1,toolbar=0,height=300,width=300');
			}
		}
	}
