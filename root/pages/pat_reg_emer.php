...
<div class="container-fluid">
	...
	<div id="search_det" style="display:none">
		...
		<table id="padd_tbl" class="table table-condensed">
			...
			<tr>
				<th>Sample No <br />
					<input type="text" style="width:30px;" value="EC/" readonly>
					<input type="text" style="width:60px;" id="bill_no_upd" onkeyup="load_emp_event(event)"
				...
				<th>Patient No <br />
					<input type='text' value="" id="patient_no_upd" onkeyup="load_emp_event(event)"
	...
	<div id="reg_div" tabindex='1' onkeyup="move_focus(event)">
		...
		<table class="table table-bordered table-condensed">
			...
			<tr>
				<th>Hosp No:</th>
				<td colspan="2"> <input type="text" id="hosp_no" name="c_4" placeholder="Enter Hosp. No"
			...
			<tr>
				<th>
					<label style="display:inline-block;"><input type="checkbox" id="nr" onclick="check_pat_type()">
						NR</label>
				...
				<th colspan="4">
					<select id="free" onchange="load_auth()" name="c_14" onkeyup="select_enter(this.id,event)">
					...
					<select id="auth" style="display:none" onkeyup="select_enter(this.id,event)">
					...
					<select id="auth_disc" style="display:none;width:100px;" onkeyup="select_enter(this.id,event)">
