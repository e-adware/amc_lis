...
<div class="" >
	<!--<div class="span2" >
		<img src="../../images/<?php echo $company_info["client_logo"]; ?>" type="image/jpg/png" style="width:80px;margin-top:-10px;margin-bottom:0px;" />
	</div>-->
	<div style="position: fixed;left: 0%;top:1%;border: 1px solid #000;">
		<img src="../../images/<?php echo $company_info["client_logo"]; ?>" style="width:90px;" alt="QR Code">
	</div>
