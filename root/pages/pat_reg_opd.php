...
<div style="position:fixed;right:0" id="bar_setting">
	...
	<div id="reg_div" tabindex='1' onkeyup="move_focus(event)">
		...
		<tr>
			<th>Hosp No <b style="color:#ff0000;">*</b> :</th>
		...
		<tr>
			...
			<th>Sample No <b style="color:#ff0000;">*</b></th>
			<td><input type="text" id="slno" name="c_11" onkeyup="chk_smp(1,event)" /></td>
		...
		<tr>
			...
			?>
				...
				<select class="span2" id="free" name="c_14" onchange="load_auth()" onkeydown="select_enter(this.id,event)" autofocus>
