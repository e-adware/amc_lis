			...
			<tr>
				<th colspan="4" style="text-align:center">
					...
					<input type="button" id="search_clr" value="Clear" class="btn btn-info"
						onclick="$('#hosp_no_upd').val('');$('#sample_no_upd').val('');$('#name_upd').val('');" />
				</th>
			</tr>
			<tr>
				<td colspan="4">
		...
		<table class="table table-bordered table-condensed">
			...
			-->
				...
				<th>
					...
					<!-----Ward for IPD--------------->
					<select id="ward" style="display:none">
				...
				<th>
					<select id="pat_dis" onchange="save_disease(this.value)" name="c_12"
						onkeyup="select_enter(this.id,event)">
				...
				<td colspan="7">
					<div style="border-bottom:1px solid #DDDDDD">
						<div align="center" style="border-bottom:1px solid #CCC">
							<input type="text" class="span5" id="srch_test" onfocus="load_tests1()"
								onblur="setTimeout(function(){$('#ref_doc').empty().hide();},600);"
								placeholder="Search Test Name" />
							<input type="hidden" placeholder="Search Test" onkeyup="select_test(this.value,event)"
