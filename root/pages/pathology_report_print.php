											...
											if ($param_info["ResultType"] == 7) // Pad
											{
												...
												<tr>
													...
													if (!$test_result_2) {
														?>
														<<?php echo $result_td_th; ?> class="test_result no_top_border"
															colspan="<?php echo $result_td_span; ?>" style="<?php echo $result_td_text_align; ?>"><?php echo $test_result["result"] . $result_unit_gap . $unit_info["unit_name"]; ?></<?php echo $result_td_th; ?>>
														<td class="test_ref no_top_border"><?php echo nl2br($normal_range["normal_range"]); ?></td>

														<<?php echo $result_td_th_2; ?> class="test_result no_top_border"
															colspan="<?php echo $result_td_span; ?>" style="<?php echo $result_td_text_align; ?>"><?php echo $test_result_2["result"] . $result_unit_gap . $unit_info_2["unit_name"]; ?></<?php echo $result_td_th_2; ?>>
					...
					<table class="table table-condensed table-no-top-border report_table">
						...
						while ($report_test = mysqli_fetch_array($report_test_qry)) {
							...
							if ($param_num >= 1) {
								...
								?>
								<tr>
									<th colspan="5" class="test_name no_top_border" style="text-align:center;">
				...
				<div class="row report_div" style="<?php echo $div_height; ?>">
					<table class="table table-condensed table-no-top-border report_table">
						...
						while ($report_test = mysqli_fetch_array($report_test_qry)) {
							...
							?>
							<tr>
								<th colspan="6" class="test_name no_top_border" style="text-align:center;">
									<?php echo $test_info["testname"]; ?>
								</th>
							</tr>
							<?php
							...
							if ($report_num > 0) {
								...
								if ($w1["specimen"] || $w1["incubation_temp"] || $w1["method"]) {
									...
									<tr>
										...
										<td colspan="2" class="test_name no_top_border">
											<?php if ($w1["incubation_temp"]) { ?>Incubation Temperature :
												<b><?php echo $w1["incubation_temp"]; ?>°C<?php } ?></b>
										</td>
										</td>
									</tr>
									<?php
