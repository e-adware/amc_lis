...
<div style="position:fixed;right:0" id="bar_setting">
	...
	<div id="search_det" style="display:none">
		...
		<table id="padd_tbl" class="table table-condensed">
			...
			<tr>
				<th>Sample No <br/>
					<input type="text" style="width:50px;" value="NHRM/" readonly >
					<input type="text" style="width:80px;" id="bill_no_upd" onkeyup="load_emp_event(event)" placeholder="Sample No" >
				</th>
				<th>HOSP.NO <br/>
