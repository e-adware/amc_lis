...
<div class="container-fluid">
	...
	<div id="search_det" style="display:none">
		...
		<table id="padd_tbl" class="table table-condensed">
			...
			<tr>
				<th>Sample No <br />
					<input type="text" style="width:50px;" value="NRHM/" readonly>
					<input type="text" style="width:80px;" id="bill_no_upd" onkeyup="load_emp_event(event)"
		...
		<table class="table table-bordered table-condensed">
			...
			<tr>
				...
				<th>
					...
					?>
					<select id="pat_type" name="c_0" onkeyup="select_enter(this.id,event)" autofocus>
						<option>IPD</option>
						<option>OPD</option>
					</select>
				</th>
			...
			<tr>
				...
				<th colspan="4">
					...
					<select id="free" onchange="load_auth()" style="display:none;"
...
<script>
	...
	function load_new() {
		document.location = "index.php?param=" + btoa(1044);
	}
