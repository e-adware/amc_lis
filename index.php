...
<body id="large-header" class="large-header">
	...
	<div class="login" onkeypress="hid_div(event)" style="margin-top:0px; overflow: hidden;">
		<div class="container-fluid">
			<div id="large-header" class="row large-header">
				<!-- First Column: Company Logo and Details -->
				<div class="col-md-4 text-center d-none d-md-block" ondblclick="window.location.href='./backup_db'">
				...
				<div class="col-md-4">
					<div id="loginbox" class="mainbox login-content" style="width: 90%;">
						<div class="control-group text-center" style="padding: 10px;">
						...
						<div class="control-group" style="padding: 5px;">
							...
							<div id="update_p_sim"
								style="position:absolute; width: 83%; background: #fff;margin-left: 4.5%;margin-top: -3px; z-index:9999;">
							</div>
						</div>
						<div class="control-group" style="padding: 5px;">
							<div class="controls">
						...
						<center style="padding-top: 15px;"><span id="error_mgs"></span></center>
						...
						<div class="text-center" style="color: #ff8f00;font-family: initial;margin-top:20%;"><span>Coded &amp; designed with &hearts; by <span><a href="http://www.e-adware.com" target="_blank" style="color: #ff8f00;">e-adware</a></span></span></div>
					</div>
				</div>
				...
				<div class="col-md-12" style="position:fixed;bottom:0;">
					<div id="" class="mainbox login-content" style="width: 100%;">
						<div style="color: #fff;">
							<p>This is a reminder that performing an end-of-day database backup is mandatory. All users are responsible for ensuring that backups are completed as per the established protocol.</p>
							<p>Please note that developers will not be held responsible for any data loss resulting from failure to perform the required backups. It is the responsibility of the designated personnel to ensure that backups are taken and securely stored.</p>
							<p>Your cooperation in maintaining data integrity and security is highly appreciated. <a class="btn-link" style="cursor:pointer;" onclick="window.location.href='./backup_db'">Backup Now</a></p>
						</div>
					</div>
				</div>
			</div>
		...
		$.post("login_process.php",
			...
			function (data, status) {
				...
				if (data == "1") {
					...
					window.location.href="root/processing.php?param=222";
				}
				else if (data == "404") {
