...
$name = mysqli_query($GLOBALS["___mysqli_ston"], " SELECT `emp_id`,`name` FROM `employee` WHERE `name` like '%$val%' AND `status` = '0' AND `levelid` NOT IN ($not_accountant) order by `name` ");
?>
